...
-- =============================================================================
-- TABLE 6: interviews
-- WHY: Schedule and track interview sessions
-- =============================================================================
CREATE TABLE IF NOT EXISTS interviews (
    id              BIGINT UNSIGNED  NOT NULL AUTO_INCREMENT,
    application_id  BIGINT UNSIGNED  NOT NULL,
    interviewer_id  BIGINT UNSIGNED  NOT NULL,              -- user who conducts interview
    round_number    TINYINT UNSIGNED NOT NULL DEFAULT 1,    -- 1st, 2nd, 3rd round
    ...
    meeting_link    VARCHAR(500)     NULL,                   -- Zoom/Meet URL
    status          ENUM('scheduled', 'completed', 'cancelled', 'no_show', 'rescheduled') 
                                     NOT NULL DEFAULT 'scheduled',
    ai_questions    JSON             NULL,                   -- AI-generated interview questions
    email_sent_at   DATETIME         NULL,                   -- when invite was emailed
    created_at      DATETIME         NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at      DATETIME         NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    
    PRIMARY KEY (id),
    FOREIGN KEY fk_interview_app (application_id) REFERENCES applications(id) ON DELETE CASCADE,
    FOREIGN KEY fk_interview_user (interviewer_id) REFERENCES users(id) ON DELETE RESTRICT,
...
-- =============================================================================
-- TABLE 7: evaluations
-- WHY: Post-interview feedback and AI evaluation
-- =============================================================================
CREATE TABLE IF NOT EXISTS evaluations (
    id               BIGINT UNSIGNED  NOT NULL AUTO_INCREMENT,
    interview_id     BIGINT UNSIGNED  NOT NULL,
    evaluator_id     BIGINT UNSIGNED  NOT NULL,              -- user who fills this in
    technical_score  TINYINT UNSIGNED NULL,                  -- 1-10
    communication_score TINYINT UNSIGNED NULL,
    problem_solving_score TINYINT UNSIGNED NULL,
    culture_fit_score TINYINT UNSIGNED NULL,
    overall_score    TINYINT UNSIGNED NULL,                  -- 1-10
    strengths        TEXT             NULL,
    weaknesses       TEXT             NULL,
    notes            TEXT             NULL,
    recommendation   ENUM('strong_hire', 'hire', 'maybe', 'no_hire', 'strong_no_hire') 
                                      NOT NULL,
    ai_summary       TEXT             NULL,                  -- AI-generated summary of feedback
    created_at       DATETIME         NOT NULL DEFAULT CURRENT_TIMESTAMP,
    
    PRIMARY KEY (id),
    UNIQUE KEY uq_evaluations (interview_id, evaluator_id),
    FOREIGN KEY fk_eval_interview (interview_id) REFERENCES interviews(id) ON DELETE CASCADE,
    FOREIGN KEY fk_eval_user (evaluator_id) REFERENCES users(id) ON DELETE RESTRICT,
    INDEX idx_evaluations_recommendation (recommendation)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
